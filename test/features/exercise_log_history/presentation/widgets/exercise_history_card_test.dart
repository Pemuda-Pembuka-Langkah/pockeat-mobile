...
void main() {
  ...
  testWidgets('ExerciseHistoryCard displays correct title and subtitle', (WidgetTester tester) async {
    // Build the widget
  ...
  testWidgets('ExerciseHistoryCard displays correct timeAgo', (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('ExerciseHistoryCard shows correct icon for smart exercise', (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('ExerciseHistoryCard shows correct icon for cardio', (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('ExerciseHistoryCard shows correct icon for weightlifting', (WidgetTester tester) async {
    // Build the widget
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('ExerciseHistoryCard calls onTap callback when tapped', (WidgetTester tester) async {
