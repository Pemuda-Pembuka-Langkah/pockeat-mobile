...
void main() {
  ...
  group('SyncFitnessTrackerOptionPage', () {
    testWidgets('renders with modern UI components and gradient background', (tester) async {
      ...
      final subtitleFinder = find.text('Connect to a fitness tracker to sync your activity data');
      ...
      expect(find.text('Automatic exercise calorie adjustment'), findsOneWidget);
    ...
    testWidgets('tapping Continue saves preference and navigates', (tester) async {
      await tester.pumpWidget(createTestWidget());
      await tester.pump();
