...
void main() {
  ...
  group('ExerciseOptionCard positive tests', () {
    ...
    testWidgets('has correct styling', (WidgetTester tester) async {
      ...
      expect(decoration.color, equals(color.withOpacity(0.95)));
    ...
    testWidgets('navigates to correct route when tapped',
  ...
  group('ExerciseOptionCard negative tests', () {
    testWidgets('handles very long text without crashing',
        (WidgetTester tester) async {
      // Test with extremely long title and subtitle
      const String longTitle =
          'This is an extremely long title that would probably cause overflow in most UI components if not handled properly';
      const String longSubtitle =
          'This is an extremely long subtitle that would also likely cause overflow issues if the widget does not implement proper text overflow handling';
    ...
    testWidgets('handles empty strings for title and subtitle',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgets('handles transparent color without visual issues',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
    ...
    testWidgets('handles empty route without crashing',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
