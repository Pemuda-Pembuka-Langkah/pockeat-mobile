...
void main() {
  ...
  group('CardioInputPage Widget Tests', () {
    ...
    testWidgets('Back button interaction should work', (WidgetTester tester) async {
      await tester.pumpWidget(createCardioInputPage());
  ...
  group('Swimming Form Tests', () {
    ...
    testWidgets('Swimming form should handle stroke selection', (WidgetTester tester) async {
      await tester.pumpWidget(createCardioInputPage());
  ...
  group('Integration Tests', () {
    ...
    testWidgets('Cycling activity end-to-end test', (WidgetTester tester) async {
      // Setup repository response
      when(mockRepository.saveCardioActivity(any))
          .thenAnswer((_) async => 'activity-id-123');
    ...
    testWidgets('Swimming activity end-to-end test', (WidgetTester tester) async {
      // Setup repository response
      when(mockRepository.saveCardioActivity(any))
          .thenAnswer((_) async => 'activity-id-123');
