...
enum BackgroundServiceConfig {
  ...
  static const String PERIODIC_UPDATE_TASK_ID =
      'com.pockeat.widgets.periodicUpdate';
  static const String MIDNIGHT_UPDATE_TASK_ID =
      'com.pockeat.widgets.midnightUpdate';
}
