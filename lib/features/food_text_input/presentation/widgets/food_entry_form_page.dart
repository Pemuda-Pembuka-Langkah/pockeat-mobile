...
class _FoodEntryFormState extends State<FoodEntryForm> {
  ...
  Future<void> _performAnalysis() async {
    ...
    try {
      // Use food description for analysis
  ...
  void _saveForm() {
    ...
    _descriptionError = FormValidator.validateDescription(
      _descriptionController.text, 
      widget.maxDescriptionWords
    );
    
    setState(() {});

    bool isValid = _descriptionError == null;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailItem('Description', _savedFoodEntry!.foodDescription),
          const SizedBox(height: 16),
