...
class _HeightWeightPageState extends State<HeightWeightPage> with SingleTickerProviderStateMixin {
            ...
            child: Column(
              ...
              children: [
                ...
                const OnboardingProgressIndicator(
                  totalSteps: 16,
                  currentStep: 1, // This is the second step (0-indexed)
                  barHeight: 6.0,
                  showPercentage: true,
                ),
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  borderSide: BorderSide(color: _heightErrorText != null ? errorColor : Colors.grey.shade300),
                                ),
                                focusedBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(8),
                                  borderSide: BorderSide(color: _heightErrorText != null ? errorColor : primaryGreen, width: 1.5),
                                ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text('30 kg', style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                                  Text('150 kg', style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
                                ],
                              ),
                            ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: _getBMIStatusColor().withOpacity(0.2),
                                      borderRadius: BorderRadius.circular(12),
                                    ),
                                    child: Text(
                                      _getBMICategory(),
                              ...
                              ClipRRect(
                                ...
                                child: LinearProgressIndicator(
                                  ...
                                  valueColor: AlwaysStoppedAnimation<Color>(_getBMIStatusColor()),
                                ),
                              ),
                              const SizedBox(height: 12),
                              Text(
              ...
              SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: _isFormValid() ? _handleNextPressed : null,
                          child: const Text(
                            "Add Measurements",
                            style: TextStyle(
                              fontSize: 16,
