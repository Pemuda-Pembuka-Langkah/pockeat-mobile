...
class _AddCaloriesBackPageState extends State<AddCaloriesBackPage> with SingleTickerProviderStateMixin {
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () => setState(() => _addCaloriesBack = false),
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(vertical: 16),
                                        decoration: BoxDecoration(
                                          color: _addCaloriesBack == false ? primaryGreen : Colors.transparent,
                                          borderRadius: BorderRadius.horizontal(left: Radius.circular(15)),
                                        ),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            if (_addCaloriesBack == false)
                                              Container(
                                            ...
                                            if (_addCaloriesBack == false) const SizedBox(width: 8),
                                            Text(
                                              "No",
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.w600,
                                                color: _addCaloriesBack == false ? Colors.white : Colors.black87,
                                              ),
                                            ),
                                          ],
                                        ),
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () => setState(() => _addCaloriesBack = true),
                                      child: Container(
                                        padding: const EdgeInsets.symmetric(vertical: 16),
                                        decoration: BoxDecoration(
                                          color: _addCaloriesBack == true ? primaryGreen : Colors.transparent,
                                          borderRadius: BorderRadius.horizontal(right: Radius.circular(15)),
                                        ),
                                        child: Row(
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            if (_addCaloriesBack == true)
                                              Container(
                                                padding: const EdgeInsets.all(4),
                                                decoration: const BoxDecoration(
                                                  color: Colors.white,
                                            ...
                                            if (_addCaloriesBack == true) const SizedBox(width: 8),
                                            Text(
                                              "Yes",
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.w600,
                                                color: _addCaloriesBack == true ? Colors.white : Colors.black87,
                                              ),
                                            ),
                                          ],
                                        ),
