...
class LogHistorySubtabsWidget extends StatefulWidget {
  ...
  @override
  State<LogHistorySubtabsWidget> createState() => _LogHistorySubtabsWidgetState();
}

class _LogHistorySubtabsWidgetState extends State<LogHistorySubtabsWidget> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return SliverVisibility(
      visible: widget.mainTabController.index == 1,
      sliver: SliverAppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Padding(
            ...
            child: Container(
              ...
              child: Row(
                children: widget.tabConfiguration.logHistoryTabLabels.asMap().entries.map((entry) {
