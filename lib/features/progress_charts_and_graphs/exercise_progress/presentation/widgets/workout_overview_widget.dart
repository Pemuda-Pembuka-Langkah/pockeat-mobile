...
class WorkoutOverviewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isWeeklyView) {
      ...
      final List<String> expectedWeeks = [
        'Week 1',
        'Week 2',
        'Week 3',
        'Week 4'
      ...
      if (exerciseData.length == 4 &&
        ...
        displayData =
            expectedWeeks.map((week) => ExerciseData(week, 0)).toList();
      }
    }
        ...
        children: [
          ...
          Row(
            ...
            children: workoutStats
                .map((stat) => WorkoutStatWidget(stat: stat))
                .toList(),
          ),
          const SizedBox(height: 20),
          SizedBox(
            ...
            child: SfCartesianChart(
              ...
              tooltipBehavior: TooltipBehavior(
                  enable: true, header: '', format: 'point.x: point.y kcal'),
