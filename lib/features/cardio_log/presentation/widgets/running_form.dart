...
class RunningForm extends StatefulWidget {
  ...
  double calculateCalories() {
    final state = (key as GlobalKey<State<RunningForm>>).currentState;
    if (state is _RunningFormState) {
  ...
  @override
  State<RunningForm> createState() => _RunningFormState();
}

class _RunningFormState extends State<RunningForm> {
  int selectedKm = 5;
  int selectedMeter = 0;
